    ...
    methods:{
        addBorrower(){
            ...
            axios.post(`application/controllers/borrower.controller.php`, 
            {
                ...
                message = "<ul>";
                if(data.borrower){
                    message += "<li>Borrower successfully added.</li>"
                }else{
                    message += "<li>Failed to add Borrower.</li>"
                }
                if(data.spouse){
                    message += "<li>Spouse successfully inserted.</li>"
                }else{
                    message += "<li>Spouse has not been added.</li>"
                }
                if(data.borrower_income){
                    message += "<li>Borrower's income successfully inserted.</li>"
                }else{
                    message += "<li>Failed to insert Borrower's income.</li>"
                }
                if(data.borrower_expense){
                    message += "<li>Borrower's expense successfully inserted.</li>"
                }else{
                    message += "<li>Failed to add Borrower's expense.</li>"
                }
                message += "<ul>";
...
var addComaker = new Vue({
    ...
    methods:{
        addComaker(){
            ...
            axios.post(`application/controllers/borrower.controller.php`, 
            {
                ...
                message = "<ul>";
                if(data.comaker){
                    message += "<li>Comaker successfully added.</li>"
                }else{
                    message += "<li>Failed to add Comaker.</li>"
                }
                message += "<ul>";
                alertify.alert('Message', message,
                 function(){ 
    ...
    created() {
        this.getToInsertSelect('employer',['borrower'])
    },
    data: function(){
        return {
            order: {
