<?php require_once('application/views/modals/editEmployee.modal.php');?>
<section class="content">
	<div class="box box-info">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								<a href="#edit-employee-modal" data-toggle="modal"> <i class="fa fa-edit fa-lg"></i></a> 
								&nbsp;| &nbsp;
								<a href="javascript:;" id="delete"> <i class="fa fa-trash fa-lg text-danger"></i></a>
							</td>
						</tr>
						<?php endforeach;?>
						<?php else:?>
		...
		<div class="box-footer clearfix">
			<a class="btn btn-info btn-lg float-right btn-flat">
